...
(function($) {
  ...
  var apiKey,
      ...
      updateTrackInfo = function($player, track) {
        ...
        $('.sc-waveform-container', $player).html('<img src="/assets/css/sc-player-red/img/waveform.png" />');
  ...
  $.scPlayer = function(options, node) {
    var opts = $.extend({}, $.scPlayer.defaults, options),
        ...
        $player
          .find('.sc-controls')
            .append('<a href="#play" class="sc-play">Play</a> <a href="#pause" class="sc-pause hideme">Pause</a>')
          .end()
  ...
  $.scPlayer.defaults = $.fn.scPlayer.defaults = {
    ...
    apiKey: '177221388aee279eb1ca838a677f1474'
  };
